...
// consume ack bytes after certain communications:
// master-master meaning receiver ack
// master-slave meaning sender ack [middle one consumed with slave part]
public class AckTelegramDecoder extends ByteToMessageDecoder {
